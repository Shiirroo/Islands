...
public class Raw_Iron_Block extends BlockCreator {
    ...
    public List<RecipeCreator> itemRecipe() {
        return List.of(new RecipeCreator().addItems(new Broken_Iron(), 9));
    }
    ...
    public ItemStack setItemStack() {
        ItemStack itemStack = new ItemStack(Material.RAW_IRON_BLOCK);
        ItemMeta itemMeta = itemStack.getItemMeta();
        itemMeta.setDisplayName("Raw Iron");
