package de.shiirroo.islands.gamedata.game.chunk.chunks.stone;
...
public class StoneChunk extends ChunkCreator implements Serializable {
    @Serial
    ...
    public ArrayList<BlockDataCreator> getChunkMaterialList() {
        return new ArrayList<>(Arrays.asList(
                new BlockDataCreator(new Stone()),
                new BlockDataCreator(new Cobblestone())));
    }
    ...
    public ItemStack chunkDisplayItem() {
        ...
        itemMeta.setDisplayName("Stone Island");
    ...
    public List<BlockCreator> placedOn() {
        return List.of(new Stone(), new Cobblestone());
    }
