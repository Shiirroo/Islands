package de.shiirroo.islands.gamedata.game.items.gameitems.items.common;
...
public class Melon_Slice extends ItemCreator {
    ...
    public ItemStack setItemStack() {
        ItemStack itemStack = new ItemStack(Material.MELON_SLICE);
        ItemMeta itemMeta = itemStack.getItemMeta();
        itemMeta.setDisplayName("Melon Slice");
