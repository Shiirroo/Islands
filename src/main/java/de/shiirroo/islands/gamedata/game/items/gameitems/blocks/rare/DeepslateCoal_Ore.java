...
public class DeepslateCoal_Ore extends BlockCreator {
    ...
    public ItemStack setItemStack() {
        ItemStack itemStack = new ItemStack(Material.DEEPSLATE_COAL_ORE);
        ItemMeta itemMeta = itemStack.getItemMeta();
        itemMeta.setDisplayName("Deepslate Coal Ore");
