package de.shiirroo.islands.gamedata.game.chunk.chunks.dragon;
...
public class DragonChunk extends ChunkCreator implements Serializable {
    ...
    public ItemStack chunkDisplayItem() {
        ...
        itemMeta.setDisplayName("Dragon Island");
