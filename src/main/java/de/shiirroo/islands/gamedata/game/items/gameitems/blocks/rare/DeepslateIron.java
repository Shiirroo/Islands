...
public class DeepslateIron extends BlockCreator {
    ...
    public ItemStack setItemStack() {
        ItemStack itemStack = new ItemStack(Material.DEEPSLATE_IRON_ORE);
        ItemMeta itemMeta = itemStack.getItemMeta();
        itemMeta.setDisplayName("Deepslate Iron Ore");
