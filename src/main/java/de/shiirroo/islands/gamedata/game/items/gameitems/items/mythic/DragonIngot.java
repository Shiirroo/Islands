...
public class DragonIngot extends ItemCreator {
    ...
    public List<RecipeCreator> itemRecipe() {
        return List.of(new RecipeCreator().addItems(new RawDragonOre(), 1).addItems(new MoltenLava(), 1));
    }
    ...
    public ItemStack setItemStack() {
        ...
        itemMeta.setDisplayName("Dragon Ingot");
    ...
    public ItemsTyp setItemsTyp() {
        return ItemsTyp.CRAFTINGMATERIAL;
    }
}
