package de.shiirroo.islands.gamedata.game.items.gameitems.items.rare;
...
public class Iron_Ingot extends ItemCreator {
    ...
    public List<RecipeCreator> itemRecipe() {
        return List.of(new RecipeCreator().addItems(new Raw_Iron_Block(), 1).addItems(new Coal(), 4));
    }
    ...
    public ItemStack setItemStack() {
        ...
        itemMeta.setDisplayName("Iron Ingot");
