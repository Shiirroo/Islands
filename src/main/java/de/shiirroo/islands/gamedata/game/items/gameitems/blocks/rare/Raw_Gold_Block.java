...
public class Raw_Gold_Block extends BlockCreator {
    ...
    public List<RecipeCreator> itemRecipe() {
        return List.of(new RecipeCreator().addItems(new BrokenGold(), 9));
    }
    ...
    public ItemStack setItemStack() {
        ItemStack itemStack = new ItemStack(Material.RAW_GOLD_BLOCK);
        ItemMeta itemMeta = itemStack.getItemMeta();
        itemMeta.setDisplayName("Raw Gold");
