...
public class NetherChunk extends ChunkCreator implements Serializable {

    @Override
    public ArrayList<BlockDataCreator> getChunkMaterialList() {
        return new ArrayList<>(List.of(
                new BlockDataCreator(new Netherrack_Gold())));
    ...
    public ItemStack chunkDisplayItem() {
        ...
        itemMeta.setDisplayName("Nether Island");
    ...
    public List<BlockCreator> placedOn() {
        ...
        return List.of(blockCreator, blockCreator,new Netherrack_Gold());
    }
